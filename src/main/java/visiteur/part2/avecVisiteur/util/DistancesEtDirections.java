package visiteur.part2.avecVisiteur.util;

import visiteur.part2.avecVisiteur.visu.Positionnable;/* Utilitaires pour des calculs de distance et de direction */
